...
var InterpolateHtmlPlugin = require('brysgo-react-dev-utils/InterpolateHtmlPlugin');
...
```js
var path = require('path');
var ModuleScopePlugin = require('brysgo-react-dev-utils/ModuleScopePlugin');
...
```js
var path = require('path');
var WatchMissingNodeModulesPlugin = require('brysgo-react-dev-utils/WatchMissingNodeModulesPlugin');
...
```js
var path = require('path');
var checkRequiredFiles = require('brysgo-react-dev-utils/checkRequiredFiles');
...
```js
var clearConsole = require('brysgo-react-dev-utils/clearConsole');
...
```js
const eslintFormatter = require('brysgo-react-dev-utils/eslintFormatter');
...
} = require('brysgo-react-dev-utils/FileSizeReporter');
...
var formatWebpackMessages = require('brysgo-react-dev-utils/formatWebpackMessages');
...
```
  const printBuildError = require('brysgo-react-dev-utils/printBuildError')
  try {
    build()
  } catch(e) {
...
```js
var getProcessForPort = require('brysgo-react-dev-utils/getProcessForPort');
...
```js
var path = require('path');
var openBrowser = require('brysgo-react-dev-utils/openBrowser');
...
module.exports = {
  ...
  entry: [
    ...
    'brysgo-react-dev-utils/webpackHotDevClient',
    'src/index'
  ],
  // ...
}
